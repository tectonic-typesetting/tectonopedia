...
%
% "terms": classic wiki-style linking.
%
% TODO: add starred variant when the typeset form of the term is different than
% the plaintext.
\makeatletter
...
\def\`{%
  \begingroup
  % Need to do \@noligs before our customization because \@noligs resets the
  % catcode of ` to be active!
  \@noligs
  \catcode`\\=12
  \catcode`\$=12
  \catcode`\&=12
